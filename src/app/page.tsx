          ...
          <ScrollReveal>
            <div className="max-w-4xl">
              ...
              <div className="space-y-8">
                <p className="text-lg tablet:text-xl font-medium text-black leading-relaxed tracking-wide">
                  WE PARTNER WITH EARLY-STAGE STARTUPS TO HELP THEM NAVIGATE THE
                  COMPLEX JOURNEY FROM IDEA TO PRODUCT-MARKET FIT AND BEYOND.
                  OUR HANDS-ON APPROACH COMBINES DEEP TECHNICAL EXPERTISE WITH
                  PRACTICAL BUSINESS EXPERIENCE.
                </p>
                <p className="text-lg tablet:text-xl font-medium text-black leading-relaxed tracking-wide">
                  WHETHER YOU NEED HELP BUILDING YOUR TECHNICAL FOUNDATION,
                  DEVELOPING YOUR GO-TO-MARKET STRATEGY, OR PREPARING FOR YOUR
                  NEXT FUNDING ROUND, WE PROVIDE THE EXPERTISE AND SUPPORT YOU
                  NEED TO SUCCEED.
                </p>
              </div>
            </div>
            ...
            <ScrollReveal>
              <div>
                ...
                <p className="text-lg font-medium text-black leading-relaxed mb-8 tracking-wide">
                  WE WORK WITH AMBITIOUS FOUNDERS WHO ARE BUILDING THE NEXT
                  GENERATION OF TRANSFORMATIVE COMPANIES. OUR IDEAL PARTNERS
                  ARE:
                </p>
          ...
          <div className="max-w-4xl">
            <ScrollReveal>
              ...
              <p className="text-lg font-medium text-white/80 mb-16 leading-relaxed tracking-wide max-w-2xl">
                LET&apos;S DISCUSS HOW WE CAN HELP ACCELERATE YOUR
                STARTUP&apos;S GROWTH AND SUCCESS. GET IN TOUCH TO START THE
                CONVERSATION.
              </p>
              <a
